...
<body >
 	<div class="container">	
		<form action="login" method="post" style="background-color: white; margin-top: 50px; margin-left: 200px; margin-right: 200px; border: 1px solid black; border-radius: 10px;">
				<span></span><br>
				<h1 style="text-align: center; color: red;">Admin Login Panel</h1>
			<div class="container">
			<label for="email"><b>Email Address</b></label>
			    <input type="email" name="email" class="form-control" placeholder="Enter Email" required="required"><span style="color: red;">${msg }</span><br>
			<label for="password"><b>Password</b></label>    
			    <input type="password" name="password" class="form-control" placeholder="Enter Password" required="required"><br>
			 	 <input type="submit" value="login"  class="btn btn-info"><span class="psw"><a href="AdminForgotPassword.jsp" style="margin-left: 10px;">Forgot your password?</a></span><br>
			 	<span></span><br>
			</div>		
		</form>
	</div>	
